...
void ec_jacscmul_opt_h(uint32_t *z, uint32_t *scl, uint32_t *x, uint32_t *ectable,uint32_t n, uint32_t start_idx, uint32_t batch_size, uint32_t order, uint32_t pidx, uint32_t add_last);
