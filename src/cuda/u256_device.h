...
extern __device__ void madcu32(uint32_t *c, uint32_t *s, uint32_t x, uint32_t y, uint32_t a);
extern __device__ void addcu32(uint32_t *c, uint32_t *s, uint32_t x, uint32_t y);
extern __device__ void propcu32(uint32_t *x, uint32_t c, uint32_t digit);
