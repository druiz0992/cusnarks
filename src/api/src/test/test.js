...
export LD_LIBRARY_PATH=/mnt/disk2/tester/cusnarks/lib:$LD_LIBRARY_PATH
cd /mnt/disk2/tester/cusnarks/src/python
CUDA_VISIBLE_DEVICES=1,2 python3 pysnarks.py -m p -pk /mnt/disk2/tester/cusnarks/circuits/pk-1-8.bin -vk /mnt/disk2/tester/cusnarks/circuits/vk-1-8.json
...
describe("cusnarks API test. ",function(){
    ...
    it("should receive a proof generation request", (done) => {
        host
        .post("/input")
        .send(input)
