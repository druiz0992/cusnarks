...
cdef extern from "types.h":
  ...
  ctypedef enum ec_callback_t:
   ...
   CB_EC_JACAFF_ADD, CB_EC_JAC_ADD, CB_EC_JACAFF_DOUBLE, CB_EC_JAC_DOUBLE, CB_EC_JAC_MUL, CB_EC_JAC_MUL1, CB_EC_JAC_MAD, CB_EC_JAC_MAD_SHFL, CB_EC_JAC_MUL_OPT, CB_EC_JAC_RED, CB_EC_JAC_MUL_PRECOMP, CB_EC_JAC_MUL_PIPPEN, CB_EC_JAC_RED1_PIPPEN, CB_EC_JAC_RED2_PIPPEN, CB_EC_JAC_RED3_PIPPEN, CB_EC_N
  
  ctypedef enum ec2_callback_t:
   CB_EC2_JACAFF_ADD, CB_EC2_JAC_ADD, CB_EC2_JACAFF_DOUBLE, CB_EC2_JAC_DOUBLE, CB_EC2_JAC_MUL, CB_EC2_JAC_MUL1, CB_EC2_JAC_MAD, CB_EC2_JAC_MAD_SHFL, CB_EC2_JAC_MUL_OPT, CB_EC2_JAC_RED, CB_EC2_JAC_MUL_PIPPEN, CB_EC2_JAC_RED1_PIPPEN, CB_EC2_JAC_RED2_PIPPEN, CB_EC2_JAC_RED3_PIPPEN, CB_EC2_N
