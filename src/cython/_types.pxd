...
cdef extern from "types.h":
  ...
  ctypedef enum u256_callback_t:
     CB_U256_ADDM , CB_U256_SUBM, CB_U256_MOD, CB_U256_MULM, CB_U256_ADDM_REDUCE,  CB_U256_ADDM_REDUCE_SHFL, CB_U256_SHL1, CB_U256_N
  ...
  ctypedef enum ec_callback_t:
   ...
   CB_EC_JACAFF_ADD, CB_EC_JAC_ADD, CB_EC_JACAFF_DOUBLE, CB_EC_JAC_DOUBLE, CB_EC_JAC_MUL, CB_EC_JAC_MAD, CB_EC_JAC_MAD_SHFL, CB_EC_N
  
  ctypedef enum ec2_callback_t:
   CB_EC2_JACAFF_ADD, CB_EC2_JAC_ADD, CB_EC2_JACAFF_DOUBLE, CB_EC2_JAC_DOUBLE, CB_EC2_JAC_MUL, CB_EC2_JAC_MAD, CB_EC2_JAC_MAD_SHFL, CB_EC2_N
  ...
  ctypedef enum zpoly_callback_t:
   ...
   CB_ZPOLY_ADD, CB_ZPOLY_SUB, CB_ZPOLY_MULC, CB_ZPOLY_MULCPREV, CB_ZPOLY_MULK, CB_ZPOLY_MADPREV, CB_ZPOLY_ADDPREV,
