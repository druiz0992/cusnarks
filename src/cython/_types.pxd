...
cdef extern from "types.h":
  ...
  ctypedef enum ec_callback_t:
   ...
   CB_EC_JACAFF_ADD, CB_EC_JAC_ADD, CB_EC_JACAFF_DOUBLE, CB_EC_JAC_DOUBLE, CB_EC_JAC_MUL, CB_EC_JAC_MUL1, CB_EC_JAC_MAD, CB_EC_JAC_MAD_SHFL, CB_EC_JAC_MUL_OPT, CB_EC_JAC_RED, CB_EC_N
