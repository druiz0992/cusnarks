...
ECP2_AFF_INDIMS  =            (6)               
ECP2_AFF_INOFFSET =           (ECP2_AFF_INDIMS * NWORDS_256BIT)
ECP2_AFF_INXOFFSET =          (0 * NWORDS_256BIT)
ECP2_AFF_INYOFFSET =          (2 * NWORDS_256BIT)
ECP2_AFF_INZOFFSET =          (4 * NWORDS_256BIT)

ECP2_JAC_OUTOFFSET =           (ECP_JAC_OUTDIMS * NWORDS_256BIT)
ECP2_JAC_OUTXOFFSET =         (0 * NWORDS_256BIT)
ECP2_JAC_OUTYOFFSET =         (2 * NWORDS_256BIT)
ECP2_JAC_INDIMS   =           (4)  
ECK2_JAC_INDIMS =              (ECP2_JAC_INDIMS)
