...
extern "C" void Fr_rawCopy(uint64_t *pRawResult, uint64_t *pRawA);
extern "C" void Fr_rawAdd(uint64_t *pRawResult, uint64_t *pRawA, uint64_t *pRawB);
extern "C" void Fr_rawSub(uint64_t *pRawResult, uint64_t *pRawA, uint64_t *pRawB);
extern "C" void Fr_rawNeg(uint64_t *pRawResult, uint64_t *pRawA);
extern "C" void Fr_rawMMul(uint64_t *pRawResult, uint64_t *pRawA, uint64_t *pRawB);
extern "C" void Fr_rawMSquare(uint64_t *pRawResult, uint64_t *pRawA);
extern "C" void Fr_rawMMul1(uint64_t *pRawResult, uint64_t *pRawA, uint64_t pRawB);
